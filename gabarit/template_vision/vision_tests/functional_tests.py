...
class Case1_e2e_pipeline(unittest.TestCase):
    ...
    def test05_TrainingE2E_object_detector(self):
        ...
        # Test it
        test.main(directory='dataset_object_detection_mini', directory_valid='dataset_object_detection_mini', model=test_model, mlflow_experiment='mlflow_test', mlflow_experiment='mlflow_test')
